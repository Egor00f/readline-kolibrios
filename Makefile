...
CFLAGS = -g -O2 -Wno-parentheses -Wno-format-security -Wno-tautological-constant-out-of-range-compare -I/home/autobuild/tools/win32/include
...
Makefiles: config.status $(srcdir)/Makefile.in
